...
require_once("../RMS1/php/operation1.php");
...
<div class="container text-center">
    <h1 class="py-4 bg-dark text-light rounded"><i class="fas fa-user-tie"></i> Roles</h1>
    ...
    <div class="d-flex justify-content-center">
        <form action="" method="post" class="w-50">
            ...
            <div class="pt-2">
             <?php inputElement("<i class='fas fa-users-cog fa-2x'></i>","Role","role_name",""); ?>
            </div>
...
<script src="../RMS1/php/mainrole.js"></script> 
</body>
</html>