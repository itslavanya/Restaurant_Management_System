...
require_once("../RMS1/php/operationusers.php");
...
<div class="container text-center">
    <h1 class="py-4 bg-dark text-light rounded"><i class="fas fa-users"></i> Users</h1>
    ...
    <div class="d-flex justify-content-center">
        <form action="" method="post" class="w-50">
            ...
            <div class="pt-2">
             <?php inputElement("<i class='fas fa-user-plus fa-2x'></i>","User","user",""); ?>
            </div>
            <div class="pt-2">
             <?php inputElement("<i class='fas fa-user-tag fa-2x'></i>","Username","user_name",""); ?>
            </div>
            <div class="pt-2">
              ...
              if(isset($_POST['read'])){
               ...
               if($result){
                   while($row = mysqli_fetch_assoc($result)){
                       ...
                       <td data-id="<?php echo $row['id'];?>"><?php echo $row['user'];?></td>
                       <td data-id="<?php echo $row['id'];?>"><?php echo $row['user_name'];?></td>
                       <td data-id="<?php echo $row['id'];?>"><?php echo $row['role_name'];?></td>
...
<script src="../RMS1/php/mainuser.js"></script> 
</body>
</html>